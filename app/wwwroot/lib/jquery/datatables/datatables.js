 ...
 *   https://datatables.net/download/#bs5/dt-2.1.8/b-3.1.2/b-html5-3.1.2/date-1.5.4/r-3.0.3
 *
 * Included libraries:
 *   DataTables 2.1.8, Buttons 3.1.2, HTML5 export 3.1.2, DateTime 1.5.4, Responsive 3.0.3
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "bs5/dt-2.1.8/b-3.1.2/b-html5-3.1.2/date-1.5.4/r-3.0.3",
