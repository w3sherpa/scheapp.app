...
namespace scheapp.app.DataServices
{
    public class ServiceDataService : IServiceDataService
    {
        ...
        public async Task<List<ServiceDuration>> GetServiceDurations(int businessId) => await _apiHelper.CallGetApi<List<ServiceDuration>>($"/Service/GetServiceDurations?businessId={businessId}");
